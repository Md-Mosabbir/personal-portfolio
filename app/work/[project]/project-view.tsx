    ...
    <div className="max-w-6xl mx-auto px-6 space-y-24">
      ...
      <section className="grid grid-cols-1  gap-10 xl:gap-16 items-center">
        ...
        <motion.div
          ...
          className="relative rounded-3xl overflow-hidden border border-gray-200 aspect-video"
        >
          {/* Project Image */}
          <Image
          ...
          {/* Gradient overlays */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(63,198,116,0.18),transparent_60%),radial-gradient(circle_at_bottom_right,rgba(255,255,255,0.35),transparent_65%)]" />
      ...
      <section className="space-y-8">
        ...
        <div className="grid gap-6 lg:gap-8 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
          ...
          <div className="grid gap-6">
            {project.images.gallery.slice(2, 4).map((_, index) => (
              <motion.div
                key={index}
